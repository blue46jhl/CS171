...
class CarbonVis {
    ...
    wrangleData(){
        ...
        let selectedCategoryCarbon = $('#climateCategorySelector').val()
    ...
    updateVis(){
        let vis = this;
        let selectedCategoryCarbon = $('#climateCategorySelector').val()
        console.log(selectedCategoryCarbon)

        // update x and y domains
        vis.x.domain(d3.extent(vis.displayData, d => d.year))
        vis.y.domain([0, d3.max(vis.displayData, d => d[selectedCategoryCarbon])]);

        vis.valueLine = d3.line()
            .x(d => vis.x(d.year))
            .y(d => vis.y(d[selectedCategoryCarbon]))
        ...
        circle.enter().append("circle")
            ...
            .attr("stroke-width", "1px")
            .attr("stroke", "black")
            .attr("cy", d=> vis.y(d[selectedCategoryCarbon]))
            .transition()
            .duration(800)
