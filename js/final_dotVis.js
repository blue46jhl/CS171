...
class DotVis {
    ...
    wrangleData() {
        ...
        absDeathsByAge = [avgYearRangeOne, avgYearRangeTwo, avgYearRangeThree, avgYearRangeFour];
    ...
    updateVis() {
        ...
        function ticked() {
            ...
            let myObject = {
                ...
                absDeathsByRace: ["White", "African", "Asian", "Indian"],
                absDeathsByAge: ["0 to 24 years", "25 to 44 years", "45 to 64 years", "65+ years"]
            }
            console.log(clusterNumber);
