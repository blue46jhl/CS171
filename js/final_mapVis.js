...
class MapVis {
    ...
    constructor(parentElement, casualtyData, geoData) {
        ...
        // define colors
        this.col_range_low = "#f5e6e8";
        this.col_range_high = "#854852";
    ...
    initVis() {
        ...
        vis.legend = vis.svg.append("g")
            .attr('class', 'legend')
            .attr('transform', `translate(${vis.width * 2.8 / 4 - 30}, ${vis.height - 45})`);
        ...
        vis.linearGradient.append("stop")
            .attr("offset", "0%")
            .attr("stop-color", "#f5e6e8");

        //Set the color for the end (100%)
        vis.linearGradient.append("stop")
            .attr("offset", "100%")
            .attr("stop-color", "#854852");
        ...
        vis.svg.append("text")
            ...
            .attr("font-size", "12px")
            .attr('transform', `translate(${vis.width * 2.8 / 4 - 30}, ${vis.height - 50})`);

        // Add a tooltip
        vis.tooltip = d3.select("body").append('div')
            .attr('class', "tooltip")
            .attr('id', 'hexmapTooltip');
    ...
    wrangleData() {
        ...
        heatDataByState.forEach(state => {
            ...
            state.value.forEach(entry => {
                ...
                heatIndex += +entry['Avg Daily Max Heat Index (C)'];
            ...
            vis.preProcessedData.push(
                {
                    ...
                    avgHeatIndex: +formatDecimalComma((heatIndex / state.value.length))
                }
            )
        });
    ...
    updateVis() {
            ...
            .on('mouseover', function (event, d) {
                ...
                vis.tooltip
                    ...
                    .html(`
                        ...
                        <h4> Death (relative): ${vis.stateMap[d.properties.iso3166_2].relDeath + " per million"}</h4>  
                        <h4> Average heat index: ${vis.stateMap[d.properties.iso3166_2].avgHeatIndex + " °C"}</h4>                        
                        </div>`);
            })
        ...
        vis.legendaxis = vis.svg.append("g")
            ...
            .attr('transform', `translate(${vis.width * 2.8 / 4 - 30}, ${vis.height - 30})`);
        ...
        vis.svg.select("#y-label")
            .text("Heat-Related Mortality per Million")
            .attr("font-family", "georgia")
            .attr("font-size", "8px");
